...
public class TouristRepository {
    ...
    public void initAttractions() {
        ...
        touristAttractions.add(new TouristAttraction("SMK", "Statens Museum for Kunst er Danmarks største kunstmuseum og huser en imponerende samling af både dansk og international kunst. Museet tilbyder værker fra renæssancen til moderne kunst og giver besøgende mulighed for at udforske både klassiske og nutidige kunstværker i smukke omgivelser.", "Helår", "https://www.smk.dk/wp-content/uploads/2022/08/JoakimZuger03141-scaled-e1716369338667.jpg"));
        touristAttractions.add(new TouristAttraction("Nyhavn", "Nyhavn er en ikonisk havn i København, kendt for sine farverige bygninger og livlige atmosfære. Området er fyldt med restauranter, barer og caféer, og det er et populært sted for både lokale og turister at nyde en afslappet middag eller tage en kanalrundfart i de charmerende både.", "Helår", "/images/istockphoto-587892190-612x612.jpg"));
